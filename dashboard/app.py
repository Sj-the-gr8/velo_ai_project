...
# `streamlit run dashboard/app.py` only puts dashboard/ on the path; add the project root.
...
# Re-read the database on a timer so mail processed by scripts/watch_inbox.py shows up without a manual refresh.
